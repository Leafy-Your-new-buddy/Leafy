...
//                .check();
    ...
    private MappedByteBuffer loadmodelfile(CameraActivity cameraActivity) throws IOException{
        AssetFileDescriptor fileDescriptor=cameraActivity.getAssets().openFd("model.tflite");
